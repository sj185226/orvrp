...
public class CapacityRouting {
    private static final Logger logger = Logger.getLogger(CapacityRouting.class.getName());
  ...
  static class DataModel {
    ...
    public final double[] demands = {
            // -1.3844807637362638E7,
            0,
            47879.6992481203,
            161958.646616541,
            309954.135338346,
    ...
    public final long[] vehicleCapacities = {2000000, 2000000, 2000000, 2000000, 2000000, 2000000};
  ...
  public static void main(String[] args) throws Exception {
    ...
    final int demandCallbackIndex = routing.registerUnaryTransitCallback((long fromIndex) -> {
      // Convert from routing variable Index to user NodeIndex.
      int fromNode = manager.indexToNode(fromIndex);
      return (long) data.demands[fromNode];
    });
